...
//    }
    ...
    // 하단 실행시 Security 동작 시키지 않기.
    //    @Bean
    //    public WebSecurityCustomizer webSecurityCustomizer() {
    //        return web -> web.ignoring().anyRequest();  // WebSecurityCustomizer 리턴. 어떠한 request도 Security 가 무시함.
    //    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                .csrf(csrf -> csrf.disable())   // CSRF(Cross-site Request Forgery: 사이트 간 요청 위조) 비활성화
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/board/write/**",
                                "/board/update/**", "/board/delete/**").hasAnyRole("MEMBER", "ADMIN")
...
//                        .deleteCookies("JSESSIONID")    // 쿠키 제거
                 ...
                 ********************************************/
                .oauth2Login(httpSecurityOAuth2LoginConfigurer -> httpSecurityOAuth2LoginConfigurer // 구글 로그인 화면으로 redirect
