...
@Service
public class PrincipalDetailService implements UserDetailsService { // Principal : 접근 주체
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // UserDetails 생성해서 리턴
        if(user != null) {
            PrincipalDetails userDetails = new PrincipalDetails(user);      // Principal 객체 생성
